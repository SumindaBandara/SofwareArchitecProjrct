  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-cover bg-center" style={{backgroundImage: "url('/public/assets/BrowsAction/pexels-pixabay-164634.jpg')"}}>
      <div className="bg-white p-8 rounded-lg shadow-md w-96">
        ...
        <p className="text-sm text-gray-600 mb-6">Have an account? <a href="#" className="text-blue-600 hover:underline">Log in</a></p>
        <form>
          <div className="mb-4">
            <label htmlFor="username" className="block text-sm font-medium text-gray-700 mb-1">Your Username</label>
            <input type="text" id="username" className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-blue-500" required />
          </div>
          <div className="mb-4">
